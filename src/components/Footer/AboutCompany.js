...
const AboutCompany = () => {
    return (
        ...
        <Row>
            ...
            establishment garner a vast base of customers, which continues to grow by the day. This business employs individuals that are 
            dedicated towards their respective roles and put in a lot of effort to achieve the common vision and larger goals of the company.
             In the near future, this business aims to expand its line of products and services and cater to a larger client base. In Pune, 
             this establishment occupies a prominent location in Bibvewadi. It is an effortless task in commuting to this establishment as 
             there are various modes of transport readily available. It is at Bibvewadi Main Road, Near Sahyadri Hospital, Opposite Post 
             Office, which makes it easy for first-time visitors in locating this establishment. It is known to provide top service in the 
             following categories: Electronic Goods Showrooms, Car Accessory Dealers, Cable Dealers, Flour Mill Dealers, TV Dealers-LG, Wire 
             Dealers, Car Audio System Dealers, Domestic Flour Mill Dealers.</p>
